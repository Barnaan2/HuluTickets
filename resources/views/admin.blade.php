    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 offset-md-2">
                <div class="card bg-light bg-gray-100 mt-4 ">
                    <div class="card-header ">
                        <h3 class="card-title">Add movie Show</h3>
                    </div>
                    <p>{{session('alert')}}</p>
                    <!-- /.card-header -->
                    <!-- form start    salami as biraa eegalta -->
                    <form  class="pl-4 pb-3"action="{{route('addMovieshow')}}" method = "post" >
                                     @csrf
                        <span class="label-input100">Movie</span>
